        ...
        public ActionResult OwnerPortal()
        {
            ...
            if (OWNER != null)
            {
                PortalViewModel model = new PortalViewModel
                {
                    ...
                    members = db.uspUserList(OWNER.UserID, null, null, null, null).Select(u => new StudentIEPViewModel() { UserID = u.UserID, FirstName = u.FirstName, LastName = u.LastName, MiddleName = u.MiddleName, RoleID = u.RoleID, KidsID = u.KIDSID.ToString(), StatusActive = u.StatusActive, StatusCode = u.StatusCode, hasIEP = u.hasIEP ?? false }).Where(l => l.StatusActive == 1).ToList()
                };
        ...
        public ActionResult MISPortal()
        {
            ...
            if (MIS != null)
            {
                PortalViewModel model = new PortalViewModel
                {
                    ...
                    members = db.uspUserList(MIS.UserID, null, null, null, null).Select(u => new StudentIEPViewModel() { UserID = u.UserID, FirstName = u.FirstName, LastName = u.LastName, MiddleName = u.MiddleName, RoleID = u.RoleID, KidsID = u.KIDSID.ToString(), StatusActive = u.StatusActive, StatusCode = u.StatusCode, hasIEP = u.hasIEP ?? false }).Where(l => l.StatusActive == 1).ToList()
                };
        ...
        public ActionResult AdminPortal(int? userId)
        {
            ...
            if (ADMIN != null)
            {
                PortalViewModel model = new PortalViewModel
                {
                    ...
                    members = db.uspUserList(ADMIN.UserID, null, null, null, null).Select(u => new StudentIEPViewModel() { UserID = u.UserID, FirstName = u.FirstName, LastName = u.LastName, MiddleName = u.MiddleName, RoleID = u.RoleID, KidsID = u.KIDSID.ToString(), StatusActive = u.StatusActive, StatusCode = u.StatusCode, hasIEP = u.hasIEP ?? false }).Where(l => l.StatusActive == 1).ToList()
                };
