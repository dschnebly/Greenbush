    ...
    public partial class Report : System.Web.UI.Page
    {
        ...
        private DataTable GetData(string districtFilter, string teacherIds, string buildingID)
        {
            ...
            using (IndividualizedEducationProgramEntities ctx = new IndividualizedEducationProgramEntities())
            {
                ...
                System.Data.Entity.Core.Objects.ObjectResult<up_ReportDraftIEPS_Result> list = ctx.up_ReportDraftIEPS(districtFilter, teacherIds, buildingID);

                foreach (up_ReportDraftIEPS_Result cs in list)
                {
