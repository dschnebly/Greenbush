...
namespace GreenBushIEP.Reports.CaseloadByProvider
{
    public partial class Report : System.Web.UI.Page
	{
		...
		private void ShowReport()
		{
			...
			MReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/CaseloadByProvider/rptCaseloadByProvider.rdlc");
		...
		private DataTable GetData(string districtFilter, string providerIds, string fiscalYear, string teacherIds, string buildingFilter, string studentIds)
		{
			...
			using (var context = new IndividualizedEducationProgramEntities())
			{
				...
				using (SqlCommand cmd = new SqlCommand("up_ReportCaseloadByProvider", conn))
				{
